...
```{r}
PLOT21<-grid.arrange(QP1, PlotB, QP6, ncol=1, nrow=3, left = text_grob("Shannon's Diversity", size=20, rot=90))
```

```{r}
pdf("Question1Plots.pdf") 

ggsave( "Question1Plots.pdf", plot=PLOT21, width =25, height = 25, units = "cm")
```
